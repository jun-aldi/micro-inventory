...
import (
	...
	"micro-inventory/warehouse-service/pkg/httpclient"
...
type WarehouseProductUsecaseInterface interface {
	...
	GetWarehouseProductsByWarehouseIDAndProductID(ctx context.Context, warehouseID, productID uint) (*model.WarehouseProduct, error) // Fixed: Changed return type to *model.WarehouseProduct to match repo and implementation
...
func (w *warehouseProductUsecase) CreateWarehouseProduct(ctx context.Context, warehouseProduct *model.WarehouseProduct) error {
	result, err := w.warehouseProductRepo.GetWarehouseProductsByWarehouseIDAndProductID(ctx, warehouseProduct.WarehouseID, warehouseProduct.ProductID)
	if err != nil {
...
func (w *warehouseProductUsecase) GetDetailWarehouse(ctx context.Context, warehouseID uint) (*model.Warehouse, []httpclient.ProductResponse, error) {
	...
	warehouse, err := w.warehouseProductRepo.GetDetailWarehouse(ctx, warehouseID, 0)
	if err != nil {
...
func (w *warehouseProductUsecase) GetDetailWarehouseProductByID(ctx context.Context, warehouseProductID uint) (*model.WarehouseProduct, *httpclient.ProductResponse, error) {
	...
	if err != nil {
		...
		return warehouseProduct, nil, err
	}
...
// GetWarehouseProductsByProductID implements [WarehouseProductUsecaseInterface].
func (w *warehouseProductUsecase) GetWarehouseProductsByProductID(ctx context.Context, productID uint) ([]model.WarehouseProduct, error) {
	return w.warehouseProductRepo.GetWarehouseProductsByProductID(ctx, productID)
}

// GetWarehouseProductsByWarehouseIDAndProductID implements [WarehouseProductUsecaseInterface].
func (w *warehouseProductUsecase) GetWarehouseProductsByWarehouseIDAndProductID(ctx context.Context, warehouseID uint, productID uint) (*model.WarehouseProduct, error) {
	return w.warehouseProductRepo.GetWarehouseProductsByWarehouseIDAndProductID(ctx, warehouseID, productID)
}
